...
```text
P0 -> 1 -> 2 核心工具 -> 3 Prometheus/Grafana -> 3.5 -> 主语言 profiling -> 7 -> 9a -> 10 -> 14 一个场景
```
...
```text
P0 -> 1 -> 2 -> 3 -> 3.5 -> 主语言 profiling -> 7 -> 9a -> 10 -> 14
```
...
```text
P0 -> 1 -> 2 -> 3 -> 3.5 -> 主语言 profiling -> 7 -> 9a -> 10 -> 11 -> 13 -> 14 Staff 场景
```
