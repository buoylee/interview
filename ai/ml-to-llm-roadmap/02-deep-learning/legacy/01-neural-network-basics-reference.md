...
>
> - 神经元 / MLP / 激活函数：[foundations/deep-learning/01-neuron-mlp-activation.md](/ai/ml-to-llm-roadmap/foundations/deep-learning/01-neuron-mlp-activation.md)
> - 反向传播 / 梯度问题：[foundations/deep-learning/02-backprop-gradient-problems.md](/ai/ml-to-llm-roadmap/foundations/deep-learning/02-backprop-gradient-problems.md)
> - Normalization / Residual / 初始化：[foundations/deep-learning/03-normalization-residual-initialization.md](/ai/ml-to-llm-roadmap/foundations/deep-learning/03-normalization-residual-initialization.md)
> - FFN / GELU / SwiGLU：[foundations/deep-learning/04-ffn-gating-for-transformer.md](/ai/ml-to-llm-roadmap/foundations/deep-learning/04-ffn-gating-for-transformer.md)
>
...
> 详细的数学原理已在 [03-微积分](/ai/ml-to-llm-roadmap/00-math-foundations/03-calculus.md) 中介绍。这里聚焦实践层面。
...
> ⬅️ [返回阶段概览](/ai/ml-to-llm-roadmap/02-deep-learning/README.md) | ➡️ [下一节：优化器 & 训练技巧](/ai/ml-to-llm-roadmap/02-deep-learning/02-optimizers-training.md)
