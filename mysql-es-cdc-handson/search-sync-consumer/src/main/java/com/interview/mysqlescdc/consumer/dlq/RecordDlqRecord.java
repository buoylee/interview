...
public record RecordDlqRecord(
    ...
    public RecordDlqRecord {
        ...
        String expected = topic + ':' + partition + ':' + offset;
        if (!expected.equals(recordId)) {
    ...
    public static RecordDlqRecord newPending(
            String recordId,
            String topic,
            int partition,
            long offset,
            ...
            String failureClass,
            String lastError) {
        return new RecordDlqRecord(recordId, topic, partition, offset, rawKey, rawPayload, failureClass,
