...
| [`10-practice/`](10-practice/) | **定容实战习题** | 把管线套五遍,每题踩一个真坑,带完整推导 |
...
lab/
  sim/        # 离线、纯 stdlib、确定性 —— 零基建,每章可跑
    little.py     拨 λ,W → L,ρ,R 的 P99 曲棍球杆          (01)
  ...
  experiments/  # 每章一份 runbook:跑什么、会看到什么、为什么
    e02-model-shootout / e04-find-saturation / e05-pool-starvation
    e06-bulkhead / e07-overload-collapse / e08-read-the-signals
```
...
| README(本文件) | ✅ |
| 00–09 各章 + 10 实战习题 + 99 面试卡 | ✅ 全部完成 |
| `lab/sim/`(little/saturate/starve/bulkhead) | ✅ 14 测试通过,4 脚本可跑 |
| `lab/service/`(app/drive/compose) | ✅ 4 测试通过,实测可压出饱和曲线 |
| `lab/experiments/`(e02/04/05/06/07/08) | ✅ 6 份 runbook |
